...
import iago.tikray.tikrayv4.LoginYRegister.Register
import iago.tikray.tikrayv4.LoginYRegister.ScreenLogin
            ...
            TikrayV4Theme {
                ...
                Surface(
                    ...
                    NavHost(navController = navigationController, startDestination = Ruta.PaginaPrincipal.route  ) {
                        ...
                        composable(Ruta.PaginaLogin.route){ ScreenLogin(navigationController)}
                    }
